...
namespace Cyotek.Spriter.QuickPack.Packing
{
  ...
  internal abstract class RectanglePacker
  {
    ...
    {
      this._packingAreaWidth = packingAreaWidth;
      this._packingAreaHeight = packingAreaHeight;
    }
    ...
    {
      Point point;
      if (!this.TryPack(rectangleWidth, rectangleHeight, out point))
